              ...
              {filtered.map((service, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-[#C89B3C]/30 hover:shadow-xl hover:shadow-[#C89B3C]/10 transition-all duration-500"
                  >
